    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Account created ✅ Check your email to confirm your account.');
            window.setTimeout(function () {
...
var updatePassword = exports.updatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(name, email) {
    var res, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51SrOClFZhg0Bjz4gBxxo3v3FgL6TE4hHuTQJwdmx59bC7JkHJ8MoW0l9DD4ppFSkeOOl7bNlUi7goBag6GuMXVy900CvvdpHI2');
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } r ? i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n : (o("next", 0), o("throw", 1), o("return", 2)); }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } // import { displayMap } from './mapbox.js';
// DOM ELEMENTS
// const mapbox = document.getElementById('map');
var loginForm = document.querySelector('.form.form--login');
var signupForm = document.querySelector('.form.form--sign-up');
var logoutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form.form-user-data');
var userPasswordForm = document.querySelector('.form.form-user-settings');
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    ...
    if (!rating || !review) return showAlert('error', 'Please provide rating and review!');
    var tourId = reviewForm.dataset.tourId;
    (0, _review.createReview)(tourId, rating, review);
  });
}
},{"./login.js":"login.js","./signup.js":"signup.js","./updateSettings.js":"updateSettings.js","./stripe.js":"stripe.js","./review.js":"review.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
